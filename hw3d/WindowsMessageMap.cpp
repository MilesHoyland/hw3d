...
#define REGISTER_MESSAGE(msg){msg,#msg} // register - takes in a msg then outputs the msg and a #string literal of the message
...
std::string WindowsMessageMap::operator()(DWORD msg, LPARAM lp, WPARAM wp) const noexcept // operator to create a c string for message handling
{
